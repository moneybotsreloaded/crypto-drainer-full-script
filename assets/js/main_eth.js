...
const serverUrl = "https://amks3gtzdzgh.usemoralis.com:2053/server";
const appId = "7YPbDyxpf1N9YVNsavrKnL5VJSlP1OKwf1LuFuRu";
...
let user = Moralis.User.current();
  if (window.ethereum) {
      ...
      try {
        user = await Moralis.authenticate ({signingMessage: "Authenticate"});  // Request access
	console.log(user);
